...
public class JGHeadImgActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgMytest = (ImageView) findViewById(R.id.img_mytest);
        ...
        btnGet.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(JGHeadImgActivity.this, TextPhotoActivity.class));
            }
        });
    }
    ...
    protected void setImageToView(Intent data) {
        ...
        if (extras != null) {
            ...
            // TODO: 2016/12/17  显示大图片 
            imgMytest.setImageBitmap(photo);
